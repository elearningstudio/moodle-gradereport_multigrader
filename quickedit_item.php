...
$url = new moodle_url('/grade/report/multigrader/quickedit_item.php', array('id' => $courseid, 'itemid' => $itemid));
if ($page !== 0) {
    $url->param('page', $page);
}
if ($perpage !== 0) {
...
// Initialise the multi grader report object
$report = new grade_report_multigrader($courseid, $gpr, $context, $page);
...
$reportname = get_string('quickedititem', 'gradereport_multigrader', $a);
print_grade_page_head($COURSE->id, 'report', 'multigrader', $reportname);
