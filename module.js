 ...
 * @return {Bool}
 */
M.gradereport_multigrader.classes.report.prototype.update_feedback = function(userid, itemid, newfeedback) {
 ...
 * @return {Bool}
 */
/*M.gradereport_multigrader.classes.report.prototype.update_grade = function(userid, itemid, newgrade) {
 ...
 * @class ajax
 * @constructor
 * @this {M.gradereport_multigrader.ajax}
 * @param {M.gradereport_multigrader.classes.report} report
 * @param {Object} cfg
 */
M.gradereport_multigrader.classes.ajax = function(report, cfg) {
    this.report = report;
    ...
    if (!report.isediting) {
        ...
        for (var userid in report.users) {
            ...
            for (var itemid in report.items) {
                this.existingfields[userid][itemid] = new M.gradereport_multigrader.classes.existingfield(this, userid, itemid);
            }
        }
 ...
 * @function
 * @this {M.gradereport_multigrader.classes.ajax}
 */
M.gradereport_multigrader.classes.ajax.prototype.make_editable = function(e) {
    var node = e;
    if (e.halt) {
        e.halt();
        node = e.target;
    ...
    switch (fieldtype) {
        case 'scale':
            this.current = new M.gradereport_multigrader.classes.scalefield(this.report, node);
            break;
        case 'text':
        default:
            this.current = new M.gradereport_multigrader.classes.textfield(this.report, node);
            break;
    }
 ...
 * @param {Event} e
 */
M.gradereport_multigrader.classes.ajax.prototype.keypress_enter = function(e) {
 ...
 */
M.gradereport_multigrader.classes.ajax.prototype.keypress_tab = function(e, ignoreshift) {
    var next = null;
    if (e.shiftKey) {
        if (ignoreshift) {
            return;
 ...
 * @this {M.gradereport_multigrader.classes.ajax}
 */
M.gradereport_multigrader.classes.ajax.prototype.keypress_arrows = function(e) {
    e.preventDefault();
    var next = null;
    switch (e.keyCode) {
        case 37:    // Left
 ...
 */
M.gradereport_multigrader.classes.ajax.prototype.process_editable_field = function(next) {
 ...
 * @return {Y.Node}
 */
M.gradereport_multigrader.classes.ajax.prototype.get_next_cell = function(cell) {
 ...
 * @return {Y.Node}
 */
M.gradereport_multigrader.classes.ajax.prototype.get_prev_cell = function(cell) {
    var n = cell || this.current.node;
 ...
 * @return {Y.Node}
 */
M.gradereport_multigrader.classes.ajax.prototype.get_above_cell = function(cell) {
    var n = cell || this.current.node;
 ...
 * @return {Y.Node}
 */
M.gradereport_multigrader.classes.ajax.prototype.get_below_cell = function(cell) {
    var n = cell || this.current.node;
...
M.gradereport_grader.classes.ajax.prototype.submit = function(properties, values) {
    ...
    if (values.grade !== values.oldgrade) {
        this.pendingsubmissions.push({transaction:this.report.Y.io.queue(M.cfg.wwwroot+'/grade/report/multigrader/ajax_callbacks.php', {
            method : 'POST',
 ...
 * @param {Mixed} args
 */
M.gradereport_multigrader.classes.ajax.prototype.submission_outcome = function(tid, outcome, args) {
    // Parse the response as JSON
    try {
        outcome = this.report.Y.JSON.parse(outcome.responseText);
    } catch(e) {
        var message = M.str.gradereport_multigrader.ajaxfailedupdate;
    ...
    // Quick reference for the multi grader report
    var i = null;
    // Check the outcome
            ...
            if (outcome.row[i] && outcome.row[i].userid && outcome.row[i].itemid) {
                ...
                if (this.report.isediting) {
                    ...
                    if (!this.current || info.cell.get('id') != this.current.node.get('id')) {
                        ...
                        if (!this.current.has_changed() || confirm(M.str.gradereport_multigrader.ajaxfieldchanged)) {
 ...
 * @param {Y.Node} cell
 */
M.gradereport_multigrader.classes.ajax.prototype.display_submission_error = function(message, cell) {
    var erroroverlay = new this.report.Y.Overlay({
        headerContent : '<div><strong class="error">'+M.str.gradereport_multigrader.ajaxerror+'</strong>  <em>'+M.str.gradereport_multigrader.ajaxclicktoclose+'</em></div>',
        bodyContent : message,
        visible : false,
        zIndex : 3
    });
 ...
 * @param {Int} itemid
 */
M.gradereport_multigrader.classes.existingfield = function(ajax, userid, itemid) {
 ...
 *
 * @function
 * @this {M.gradereport_multigrader.classes.existingfield}
 * @param {Event} e
 */
M.gradereport_multigrader.classes.existingfield.prototype.keypress_enter = function(e) {
    e.preventDefault();
    this.submit();
};
/**
 ...
 */
M.gradereport_multigrader.classes.existingfield.prototype.keypress_tab = function(e, ignoreshift) {
    e.preventDefault();
    var next = null;
    if (e.shiftKey) {
        if (ignoreshift) {
 ...
 * @param {Event} e
 */
M.gradereport_multigrader.classes.existingfield.prototype.keypress_arrows = function(e) {
    var next = null;
    switch (e.keyCode) {
        case 37:    // Left
 ...
 * @param {Y.Node} node
 */
M.gradereport_multigrader.classes.existingfield.prototype.move_focus = function(node) {
    if (node) {
 ...
 * @return {Bool}
 */
M.gradereport_multigrader.classes.existingfield.prototype.has_changed = function() {
    if (this.editfeedback) {
 ...
 * @this {M.gradereport_multigrader.classes.existingfield}
 */
M.gradereport_multigrader.classes.existingfield.prototype.submit = function() {
    if (!this.has_changed()) {
        return;
    }
 ...
 * @param {Y.Node} node
 */
M.gradereport_multigrader.classes.textfield = function(report, node) {
    this.report = report;
    this.node = node;
 ...
 */
M.gradereport_multigrader.classes.textfield.prototype.keyevents = [];
M.gradereport_multigrader.classes.textfield.prototype.editable = false;
M.gradereport_multigrader.classes.textfield.prototype.gradetype = null;
M.gradereport_multigrader.classes.textfield.prototype.grade = null;
M.gradereport_multigrader.classes.textfield.prototype.report = null;
M.gradereport_multigrader.classes.textfield.prototype.node = null;
M.gradereport_multigrader.classes.textfield.prototype.gradespam = null;
M.gradereport_multigrader.classes.textfield.prototype.inputdiv = null;
M.gradereport_multigrader.classes.textfield.prototype.editfeedback = false;
/**
 ...
 * @return {Object}
 */
M.gradereport_multigrader.classes.textfield.prototype.commit = function() {
 ...
 * @this {M.gradereport_multigrader.classes.textfield}
 */
M.gradereport_multigrader.classes.textfield.prototype.revert = function() {
 ...
 * @return {Mixed}
 */
M.gradereport_multigrader.classes.textfield.prototype.get_grade = function() {
    if (this.editable) {
 ...
 * @param {Mixed} value
 */
M.gradereport_multigrader.classes.textfield.prototype.set_grade = function(value) {
    if (!this.editable) {
        if (value == '-') {
            value = '';
        }
 ...
 * @return {String}
 */
M.gradereport_multigrader.classes.textfield.prototype.get_feedback = function() {
    if (this.editable) {
 ...
 * @param {Mixed} value
 */
M.gradereport_multigrader.classes.textfield.prototype.set_feedback = function(value) {
    if (!this.editable) {
 ...
 * @return {Bool}
 */
M.gradereport_multigrader.classes.textfield.prototype.has_changed = function() {
 ...
 * @this {M.gradereport_multigrader.classes.textfield}
 */
M.gradereport_multigrader.classes.textfield.prototype.attach_key_events = function() {
 ...
 * @class scalefield
 * @constructor
 * @inherits M.gradereport_multigrader.classes.textfield
 * @base M.gradereport_multigrader.classes.textfield
 * @this {M.gradereport_multigrader.classes.scalefield}
 * @param {M.gradereport_multigrader.classes.report} report
 * @param {Y.Node} node
 */
M.gradereport_multigrader.classes.scalefield = function(report, node) {
    this.report = report;
    this.node = node;
    this.gradespan = node.one('.gradevalue');
    this.inputdiv = this.report.Y.Node.create('<div></div>');
    this.editfeedback = this.report.ajax.showquickfeedback;
    this.grade = this.report.Y.Node.create('<select type="text" class="text" /><option value="-1">'+M.str.gradereport_multigrader.ajaxchoosescale+'</option></select>');
 ...
 */
M.gradereport_multigrader.classes.scalefield.prototype.get_grade = function(){
    if (this.editable) {
 ...
 * @param {String} value
 */
M.gradereport_multigrader.classes.scalefield.prototype.set_grade = function(value) {
    if (!this.editable) {
        if (value == '-') {
            value = '-1';
        }
 ...
 * @return {Bool}
 */
M.gradereport_multigrader.classes.scalefield.prototype.has_changed = function() {
    if (!this.editable) {
        return false;
    }
 ...
 */
for (var i in M.gradereport_multigrader.classes.textfield.prototype) {
    if (!M.gradereport_multigrader.classes.scalefield.prototype[i]) {
        M.gradereport_multigrader.classes.scalefield.prototype[i] = M.gradereport_multigrader.classes.textfield.prototype[i];
    }
}
